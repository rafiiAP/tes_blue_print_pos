...
class _HomeState extends State<Home> {
  ...
  Future _printReceiveTest() async {
    List<int> bytes = [];
    String text = 'Nama'.padRight(15, ' ');
    String alamat = 'Alamat'.padRight(15, ' ');
    String petugas = 'Hp Petugas'.padRight(15, ' ');
    String tile = ':Rafii Ananda Putra ';
    String tile2 =
        ':Dsn. Blimbing, Ds. Banjaranyar, Kec. Tanjunganom, Kab. Nganjuk';
    String tile3 = ':';
    ...
    bytes += generator.text(text + tile);
    bytes += generator.text(alamat + tile2);

    bytes += generator.text(petugas + tile3);
    bytes += generator.text('12345123451234512345123451234512');
    bytes += generator.text('................................');
    bytes += generator.text('total panjang 32');
//     bytes += generator.text('Reverse text', styles: PosStyles(reverse: true));
//     bytes += generator.text(
//         'Underlined text     : rafii aaaaaaaaaaaaaaaaaaaaaa',
...
//     final Uint8List tes = data.buffer.asUint8List();
//     final Image? image = decodeImage(tes);
